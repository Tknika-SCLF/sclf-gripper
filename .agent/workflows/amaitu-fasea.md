...
5. Erabili `multi_replace_file_content` tresna proiektuaren erroko `README.md`-n "Faseen Probak eta Adibideak" atalean lotura (link) edo aipamen labur bat gehitzeko aurrera eramandako testari buruz. Zihurtatu ere proiektuko hiru backlog fitxategietan (`TASKS.md`, `TASKS.es.md`, `TASKS.en.md`) fasea `[x]` bezela markatzen duzula sintonizazioa mantentzeko.
// turbo
