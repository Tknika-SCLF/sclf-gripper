...
### Key Pin Assignments (STM32G474CEU6)
- **SWD:** PA13 (DIO), PA14 (CLK), PG10 (RST) — programming pads on board
- **BOOT button:** PB8 — hold during reset to enter DFU bootloader
- **RESET button:** PG10
- **Current sense test:** PA2 (ADC)
- **PWM test:** PA10
